...
- Build a robust predictive model for bankruptcy classification.  
...
- Develop a reproducible and scalable analytical pipeline.  
...
| Gradient Boosting | 93.23% | 0.96 | 0.72 |
| KNN | 93.46% | 0.97 | 0.76 |
...
- **Sectoral performance:** Higher accuracy in manufacturing vs. service sectors.  
...
- **Regulators:** Detect systemic financial instability across sectors.  
...
1. UtkarshX27 – *US Company Bankruptcy Prediction*, Kaggle (2023)  
2. Altman, E. (1968). *Financial Ratios, Discriminant Analysis, and the Prediction of Corporate Bankruptcy*  
3. Beaver, W. (1966). *Financial Ratios as Predictors of Failure*  
4. Vukčević, M. et al. (2024). *Modern Models for Predicting Bankruptcy*, PLOS ONE  
5. Ding, Y. & Yan, C. (2024). *Corporate Financial Distress Prediction*, arXiv:2404.12610  
...
By combining **robust preprocessing**, **ensemble learning**, and **explainable AI**, this framework provides a **scalable solution for financial risk analytics**.
